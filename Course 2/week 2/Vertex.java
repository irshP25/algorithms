...
public class Vertex {
	 ...
	 * Creates a new vertex with the specified value
	 value- integer value for the vertex
	 */
	 ...
	 * Sets the integer value for the vertex
	  value - integer value to be associated with the vertex
	 */
	 ...
	 * Adds a new vertex to the adjacency list with the specified weight
	  newVertex - vertex to be added to the list of adjacent nodes
	 weight - path length to from this to the vertex to be added
	 */
